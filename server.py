...
@app.route('/grocery/upload', methods=['POST'])
def upload():
...
@app.route('/grocery/static', methods=['POST'])
def for_static():
    global processed_images
    r = request
    data = r.data
...
@app.route('/grocery/processed')
def show_processed():
    return render_template("grocery_gallery.html", image_names=processed_images)


@app.route('/grocery/upload/<filename>')
def send_image(filename):
    return send_from_directory(conf.grocery['dir'], filename)


@app.route('/grocery/gallery')
def get_gallery():

...
function isLiteral(t) {
  return !(
    "object" != (typeof t === "undefined" ? "undefined" : _typeof(t)) ||
    !t.type.match(/Literal$/)
  );
}
function buildMustache(t, e, r, a, i) {
  return (
    isLiteral(t) || (t = buildPath(t)),
    {
...
function buildLoc() {
  for (
    var _len = arguments.length, t = Array(_len), _key = 0;
    _key < _len;
    _key++
  ) {
  ...
  if (1 === t.length) {
    ...
    return e &&
      ...
      ? {
          source: buildSource(e.source),
          start: buildPosition(e.start.line, e.start.column),
          end: buildPosition(e.end.line, e.end.column)
        }
      : SYNTHETIC;
  }
  {
    var _e = t[0],
      ...
      n = t[4];
    return {
      source: buildSource(n),
      start: buildPosition(_e, r),
      end: buildPosition(a, i)
    };
  }
}
function literal(t) {
...
function parseBlockParams(t) {
  ...
  if (-1 !== a && e > a && "|" === r[a + 1].charAt(0)) {
    ...
    var n = [];
    for (var s = a + 1; s < e; s++) {
      var _e2 = r[s].replace(/\|/g, "");
      if ("" !== _e2) {
        if (ID_INVERSE_PATTERN.test(_e2))
          throw new SyntaxError$1(
    ...
    return (t.attributes = t.attributes.slice(0, a)), n;
  }
  return null;
}
...
function updateTokenizerLocation(t, e) {
  var r = e.loc.start.line,
    ...
    i = calculateRightStrippedOffsets(e.original, e.value);
  (r += i.lines),
    i.lines ? (a = i.columns) : (a += i.columns),
    (t.line = r),
    (t.column = a);
}
...
function addElementModifier(t, e) {
  ...
  var s = b.elementModifier(r, a, i, n);
  t.modifiers.push(s);
}
function addInElementHash(t, e, r) {
  ...
  e.pairs.forEach(function(t) {
    if ("guid" === t.key)
      throw new SyntaxError$1("Cannot pass `guid` from user space", r);
    "nextSibling" === t.key && (a = !0);
  });
  var i = b.literal("StringLiteral", t),
    n = b.pair("guid", i);
  if ((e.pairs.unshift(n), !a)) {
    var _t = b.literal("NullLiteral", null),
      _r = b.pair("nextSibling", _t);
    e.pairs.push(_r);
  }
  return e;
}
...
function visitNode(t, e) {
  ...
  if (
    ...
    if (JSON.stringify(e) !== JSON.stringify(r))
      return Array.isArray(r) ? visitArray(t, r) || r : visitNode(t, r) || r;
    r = void 0;
  }
  if (void 0 === r) {
    var i = visitorKeys[e.type];
...
function visitKey(t, e, r, a) {
  ...
  if (!i) return;
  var n = void 0,
    s = e && (e.keys[a] || e.keys.All);
  if (s && s.enter && void 0 !== (n = s.enter.call(null, r, a)))
    throw cannotReplaceOrRemoveInKeyHandlerYet(r, a);
  if (Array.isArray(i)) visitArray(t, i);
  else {
    var _e4 = visitNode(t, i);
    void 0 !== _e4 && assignKey(r, a, _e4);
  }
  if (s && s.exit && void 0 !== (n = s.exit.call(null, r, a)))
    throw cannotReplaceOrRemoveInKeyHandlerYet(r, a);
}
function visitArray(t, e) {
  for (var r = 0; r < e.length; r++) {
    var a = visitNode(t, e[r]);
    void 0 !== a && (r += spliceArray(e, r, a) - 1);
  }
}
function assignKey(t, e, r) {
  if (null === r) throw cannotRemoveNode(t[e], t, e);
  if (Array.isArray(r)) {
    if (1 !== r.length)
      throw 0 === r.length
        ? cannotRemoveNode(t[e], t, e)
        : cannotReplaceNode(t[e], t, e);
    t[e] = r[0];
  } else t[e] = r;
}
function spliceArray(t, e, r) {
  return null === r
    ? (t.splice(e, 1), 0)
    : Array.isArray(r)
      ? (t.splice.apply(t, [e, 1].concat(_toConsumableArray(r))), r.length)
      : (t.splice(e, 1, r), 1);
}
  ...
  for (var r in t) {
    ...
    if ("object" == (typeof a === "undefined" ? "undefined" : _typeof(a))) {
      ...
      if (_t2)
        for (var _e5 in _t2) {
          var _r3 = _t2[_e5];
          "object" == (typeof _r3 === "undefined" ? "undefined" : _typeof(_r3))
            ? (i[_e5] = {
                enter: "function" == typeof _r3.enter ? _r3.enter : null,
                exit: "function" == typeof _r3.exit ? _r3.exit : null
              })
            : "function" == typeof _r3 && (i[_e5] = { enter: _r3, exit: null });
        }
      e[r] = {
...
function build(t) {
  ...
  switch (t.type) {
    case "Program":
      {
        var _r4 = t.chained && t.body[0];
        _r4 && (_r4.chained = !0);
        var a = buildEach(t.body).join("");
        e.push(a);
      }
      break;
    case "ElementNode":
      e.push("<", t.tag),
        t.attributes.length && e.push(" ", buildEach(t.attributes).join(" ")),
        t.modifiers.length && e.push(" ", buildEach(t.modifiers).join(" ")),
        t.comments.length && e.push(" ", buildEach(t.comments).join(" ")),
        e.push(">"),
        e.push.apply(e, buildEach(t.children)),
        e.push("</", t.tag, ">");
      break;
    case "AttrNode":
      e.push(t.name, "=");
      var r = build(t.value);
      "TextNode" === t.value.type ? e.push('"', r, '"') : e.push(r);
      break;
    ...
    case "MustacheStatement":
      e.push(compactJoin(["{{", pathParams(t), "}}"]));
      break;
    case "MustacheCommentStatement":
      e.push(compactJoin(["{{!--", t.value, "--}}"]));
      break;
    ...
    case "SubExpression":
      ...
      break;
    case "BooleanLiteral":
      e.push(t.value ? "true" : "false");
      break;
    case "BlockStatement":
      {
        var _r5 = [];
        t.chained
          ? _r5.push(["{{else ", pathParams(t), "}}"].join(""))
          : _r5.push(openBlock(t)),
          _r5.push(build(t.program)),
          t.inverse &&
            (t.inverse.chained || _r5.push("{{else}}"),
            _r5.push(build(t.inverse))),
          t.chained || _r5.push(closeBlock(t)),
          e.push(_r5.join(""));
      }
      break;
    ...
    case "CommentStatement":
      e.push(compactJoin(["\x3c!--", t.value, "--\x3e"]));
      break;
    case "StringLiteral":
      e.push('"' + t.value + '"');
      break;
    case "NumberLiteral":
      e.push(String(t.value));
      break;
...
function pathParams(t) {
  ...
  switch (t.type) {
    ...
    case "ElementModifierStatement":
    case "BlockStatement":
      if (isLiteral(t.path)) return String(t.path.value);
      e = build(t.path);
      break;
    case "PartialStatement":
      e = build(t.name);
  ...
  return compactJoin([e, buildEach(t.params).join(" "), build(t.hash)], " ");
}
...
function blockParams(t) {
  ...
  return e.length ? " as |" + e.join(" ") + "|" : null;
}
...
function extension(t, e) {
  ...
  t.exports = handlebars.compile(r);
}
function assembleAttributeValue(t, e, r, a) {
  if (r) {
    if (e) return assembleConcatenatedValue(t);
    if (
      1 === t.length ||
    ...
    throw new SyntaxError$1(
      "An unquoted attribute value must be a string or a mustache, preceeded by whitespace or a '=' character, and " +
        ("followed by whitespace, a '>' character, or '/>' (on line " +
          a +
          ")"),
      b.loc(a, 0)
    );
...
function validateEndTag(t, e, r) {
  ...
  if (
    (voidMap[t.name] && !r
      ...
      : void 0 === e.tag
        ? (a = "Closing tag " + formatEndTagInfo(t) + " without an open tag.")
        : e.tag !== t.name &&
          (a =
            "Closing tag " +
            formatEndTagInfo(t) +
    ...
    throw new SyntaxError$1(a, e.loc);
}
...
function preprocess(t, e) {
  var r =
      "object" == (typeof t === "undefined" ? "undefined" : _typeof(t))
        ? t
        : lib_1(t),
    a = new TokenizerEventHandlers(t, e).acceptNode(r);
  if (e && e.plugins && e.plugins.ast)
    for (var _t3 = 0, _r6 = e.plugins.ast.length; _t3 < _r6; _t3++) {
      traverse(
        a,
        (0, e.plugins.ast[_t3])(
          assign({}, e, { syntax: syntax }, { plugins: void 0 })
        ).visitor
      );
    }
  return a;
...
function parse(t) {
  try {
    ...
    var e = t.message.match(/on line (\d+)/);
    throw e
      ? parserCreateError(t.message, {
          start: { line: +e[1], column: 0 },
          end: { line: +e[1], column: 80 }
        })
      : t;
  }
}
var fs = _interopDefault(require("fs")),
  ...
  nodes = Object.freeze({ isCall: isCall, isLiteral: isLiteral });
var SYNTHETIC = {
  source: "(synthetic)",
  ...
  Tokenizer = (function() {
    function t(t, e) {
      void 0 === e && (e = {}),
        ...
        (this.tokenizer = new EventedTokenizer(this, t));
    }
    return (
      ...
      (t.prototype.beginAttribute = function() {
        var t = unwrap(this.token.attributes, "current token's attributs");
      ...
      (t.prototype.appendToAttributeValue = function(t) {
        var e = unwrap(this.currentAttribute);
        (e[1] = e[1] || ""), (e[1] += t);
      }),
  ...
  _createClass(Parser, [
    ...
    },
    {
      ...
      value: function sourceForNode(t, e) {
        ...
        for (
          e
            ? ((a = e.loc.end.line - 1), (i = e.loc.end.column))
            : ((a = t.loc.end.line - 1), (i = t.loc.end.column));
          s < a;
          ...
          s++,
            (r = this.source[s]),
            s === n
              ? n === a ? l.push(r.slice(o, i)) : l.push(r.slice(o))
              : s === a ? l.push(r.slice(0, i)) : l.push(r);
        }
        return l.join("\n");
      }
    },
...
var HandlebarsNodeVisitors = (function(_Parser) {
  ...
  function HandlebarsNodeVisitors() {
    ...
    ((_this = _possibleConstructorReturn(
      this,
      (
        HandlebarsNodeVisitors.__proto__ ||
        Object.getPrototypeOf(HandlebarsNodeVisitors)
  ...
  _createClass(HandlebarsNodeVisitors, [
    ...
    },
    {
      ...
      value: function Program(t) {
        ...
        var r = void 0,
          ...
          i = t.body.length;
        if ((this.elementStack.push(a), 0 === i))
    ...
    },
    {
      ...
      value: function BlockStatement(t) {
        ...
        "in-element" === e.original &&
          (a = addInElementHash(this.cursor(), a, t.loc));
        var s = b.block(e, r, a, i, n, t.loc);
        appendChild(this.currentElement(), s);
      }
    },
    {
      ...
      value: function MustacheStatement(t) {
        ...
        switch (e.state) {
          case "tagName":
            addElementModifier(this.currentStartTag, r),
          ...
          case "beforeAttributeValue":
            this.beginAttributeValue(!1),
              appendDynamicAttributeValuePart(this.currentAttribute, r),
          ...
          case "attributeValueUnquoted":
            ...
            break;
          default:
            appendChild(this.currentElement(), r);
        }
        return r;
      }
    },
    {
      ...
      value: function ContentStatement(t) {
        updateTokenizerLocation(this.tokenizer, t),
    ...
    },
    {
      ...
      value: function CommentStatement(t) {
        ...
        switch (e.state) {
          ...
          case "beforeData":
          case "data":
            appendChild(this.currentElement(), i);
            break;
          default:
            throw new SyntaxError$1(
    ...
    },
    {
      ...
      value: function Hash(t) {
        var e = [];
        for (var r = 0; r < t.pairs.length; r++) {
          var a = t.pairs[r];
          e.push(b.pair(a.key, this.acceptNode(a.value), a.loc));
        }
...
unwrapExports(utils);
var exception = createCommonjsModule(function(t, e) {
  function r(t, e) {
    var i = e && e.loc,
      n = void 0,
      s = void 0;
    i && (t += " - " + (n = i.start.line) + ":" + (s = i.start.column));
    for (
...
var blockHelperMissing = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
      ...
      t.registerHelper("blockHelperMissing", function(e, r) {
        ...
        if (utils.isArray(e))
          return e.length > 0
            ...
            : a(this);
        if (r.data && r.ids) {
          var n = utils.createFrame(r.data);
          (n.contextPath = utils.appendContextPath(r.data.contextPath, r.name)),
            (r = { data: n });
        }
        return i(e, r);
      });
...
var each = createCommonjsModule(function(t, e) {
  e.__esModule = !0;
  var r = (function(t) {
    ...
    t.registerHelper("each", function(t, e) {
      function a(e, r, a) {
        l &&
          ...
          (o += i(t[e], {
            data: l,
            blockParams: utils.blockParams([t[e], e], [c + e, null])
          }));
      }
      ...
      if (
        (e.data &&
          e.ids &&
          (c = utils.appendContextPath(e.data.contextPath, e.ids[0]) + "."),
        utils.isFunction(t) && (t = t.call(this)),
        e.data && (l = utils.createFrame(e.data)),
        t && "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)))
      )
        if (utils.isArray(t))
...
unwrapExports(each);
var helperMissing = createCommonjsModule(function(t, e) {
  e.__esModule = !0;
  var r = (function(t) {
    return t && t.__esModule ? t : { default: t };
  })(exception);
...
var _if = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
    (e.default = function(t) {
      t.registerHelper("if", function(t, e) {
        return (
          utils.isFunction(t) && (t = t.call(this)),
          (!e.hash.includeZero && !t) || utils.isEmpty(t)
            ? e.inverse(this)
            : e.fn(this)
        );
      }),
...
unwrapExports(_if);
var log = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
    (e.default = function(t) {
...
unwrapExports(log);
var lookup = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
    (e.default = function(t) {
...
var _with = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
    (e.default = function(t) {
      t.registerHelper("with", function(t, e) {
        utils.isFunction(t) && (t = t.call(this));
        var r = e.fn;
        if (utils.isEmpty(t)) return e.inverse(this);
        var a = e.data;
        return (
          e.data &&
            e.ids &&
            ((a = utils.createFrame(
              e.data
            )).contextPath = utils.appendContextPath(
              e.data.contextPath,
              e.ids[0]
            )),
          r(t, {
            data: a,
            blockParams: utils.blockParams([t], [a && a.contextPath])
          })
        );
      });
    }),
...
unwrapExports(_with);
var helpers = createCommonjsModule(function(t, e) {
  function r(t) {
    return t && t.__esModule ? t : { default: t };
  }
  (e.__esModule = !0),
...
var inline = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
    (e.default = function(t) {
      t.registerDecorator("inline", function(t, e, r, a) {
        ...
        return (
          e.partials ||
            ...
            (i = function i(a, _i2) {
              var n = r.partials;
              r.partials = utils.extend({}, n, e.partials);
              var s = t(a, _i2);
              return (r.partials = n), s;
            })),
...
var decorators = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
...
var logger_1 = createCommonjsModule(function(t, e) {
  e.__esModule = !0;
  var r = {
    ...
    lookupLevel: function lookupLevel(t) {
      if ("string" == typeof t) {
        var e = utils.indexOf(r.methodMap, t.toLowerCase());
    ...
    log: function log(t) {
      if (
        ...
        console[e] || (e = "log");
        for (
          var a = arguments.length, i = Array(a > 1 ? a - 1 : 0), n = 1;
          n < a;
          n++
        ) {
          i[n - 1] = arguments[n];
...
var base = createCommonjsModule(function(t, e) {
  function r(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function a(t, e, r) {
  ...
  (e.__esModule = !0), (e.HandlebarsEnvironment = a);
  var i = r(exception),
    n = r(logger_1);
  e.VERSION = "4.0.10";
  ...
  a.prototype = {
    ...
    registerDecorator: function registerDecorator(t, e) {
      if ("[object Object]" === utils.toString.call(t)) {
        ...
        utils.extend(this.decorators, t);
  ...
  var o = n.default.log;
  (e.log = o), (e.createFrame = utils.createFrame), (e.logger = n.default);
});
unwrapExports(base);
var safeString = createCommonjsModule(function(t, e) {
  function r(t) {
    this.string = t;
  }
  (e.__esModule = !0),
...
var runtime = createCommonjsModule(function(t, e) {
  ...
  function i(t, e) {
    return (
      (e && "root" in e) || ((e = e ? base.createFrame(e) : {}).root = t), e
    );
  }
  function n(t, e, r, a, i, n) {
    if (t.decorator) {
      var o = {};
      (e = t.decorator(e, o, r, a && a[0], i, n, a)), s.extend(e, o);
    }
    return e;
  }
  (e.__esModule = !0),
    (e.checkRevision = function(t) {
      var e = (t && t[0]) || 1,
        r = base.COMPILER_REVISION;
      if (e !== r) {
        if (e < r) {
          var a = base.REVISION_CHANGES[r],
            i = base.REVISION_CHANGES[e];
          throw new o.default(
    ...
    (e.template = function(t, e) {
      function a(e) {
        ...
        var s =
            arguments.length <= 1 || void 0 === arguments[1]
              ...
              : arguments[1],
          o = s.data;
        a._setup(s), !s.partial && t.useData && (o = i(e, o));
        var c = void 0,
          u = t.useBlockParams ? [] : void 0;
        return (
          t.useDepths &&
            (c = s.depths
              ? e != s.depths[0] ? [e].concat(s.depths) : s.depths
              : [e]),
          (r = n(t.main, r, l, s.depths || [], o, u))(e, s)
        );
      }
      ...
      var l = {
        strict: function strict(t, e) {
          if (!(e in t)) throw new o.default('"' + e + '" not defined in ' + t);
          return t[e];
        },
        ...
        invokePartial: function invokePartial(r, a, i) {
          i.hash && ((a = s.extend({}, a, i.hash)), i.ids && (i.ids[0] = !0)),
            (r = e.VM.resolvePartial.call(this, r, a, i));
          var n = e.VM.invokePartial.call(this, r, a, i);
          if (
            (null == n &&
              e.compile &&
              ((i.partials[i.name] = e.compile(r, t.compilerOptions, e)),
              (n = i.partials[i.name](a, i))),
            null != n)
          ) {
            if (i.indent) {
              for (
        ...
        programs: [],
        program: function program(t, e, a, i, n) {
          var s = this.programs[t],
            o = this.fn(t);
          return (
            e || n || i || a
              ? (s = r(this, t, o, e, a, i, n))
              : s || (s = this.programs[t] = r(this, t, o)),
            s
          );
        },
      ...
      return (
        ...
        (a._setup = function(r) {
          r.partial
            ? ((l.helpers = r.helpers),
              (l.partials = r.partials),
              (l.decorators = r.decorators))
            : ((l.helpers = l.merge(r.helpers, e.helpers)),
              t.usePartial && (l.partials = l.merge(r.partials, e.partials)),
              (t.usePartial || t.useDecorators) &&
                (l.decorators = l.merge(r.decorators, e.decorators)));
        }),
    ...
    (e.invokePartial = function(t, e, r) {
      ...
      if (
        (r.fn &&
          r.fn !== a &&
          (function() {
            r.data = base.createFrame(r.data);
            var t = r.fn;
...
var noConflict = createCommonjsModule(function(t, e) {
  (e.__esModule = !0),
    (e.default = function(t) {
...
var handlebars_runtime = createCommonjsModule(function(t, e) {
  function r(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function a(t) {
...
var ast = createCommonjsModule(function(t, e) {
  e.__esModule = !0;
  var r = {
    helpers: {
...
unwrapExports(ast);
var parser = createCommonjsModule(function(t, e) {
  e.__esModule = !0;
  var r = (function() {
    function t() {
      this.yy = {};
    ...
    var e = {
        ...
        performAction: function performAction(t, e, r, a, i, n, s) {
          var o = n.length - 1;
          switch (i) {
            case 1:
              return n[o - 1];
            case 2:
              this.$ = a.prepareProgram(n[o]);
              break;
            case 3:
            case 4:
            case 5:
            ...
            case 9:
              this.$ = {
                ...
                value: a.stripComment(n[o]),
                strip: a.stripFlags(n[o], n[o]),
            ...
            case 10:
              ...
              break;
            case 11:
              this.$ = a.prepareRawBlock(n[o - 2], n[o - 1], n[o], this._$);
              break;
            case 12:
            ...
            case 18:
              this.$ = {
                strip: a.stripFlags(n[o - 1], n[o - 1]),
                program: n[o]
              };
              break;
            case 19:
              var l = a.prepareBlock(
                ...
                c = a.prepareProgram([l], n[o - 1].loc);
              (c.chained = !0),
                (this.$ = { strip: n[o - 2].strip, program: c, chain: !0 });
              break;
            case 20:
              this.$ = n[o];
              break;
            case 21:
              this.$ = { path: n[o - 1], strip: a.stripFlags(n[o - 2], n[o]) };
              break;
            case 22:
            case 23:
            ...
            case 24:
              this.$ = {
                ...
                hash: n[o - 1],
                indent: "",
                strip: a.stripFlags(n[o - 4], n[o]),
                loc: a.locInfo(this._$)
              };
              break;
            case 25:
              this.$ = a.preparePartialBlock(n[o - 2], n[o - 1], n[o], this._$);
              break;
            case 26:
              this.$ = {
                path: n[o - 3],
            ...
            case 29:
              ...
              break;
            case 30:
              this.$ = { type: "Hash", pairs: n[o], loc: a.locInfo(this._$) };
              break;
            case 31:
              this.$ = {
                type: "HashPair",
            ...
            case 41:
              ...
              break;
            case 42:
              this.$ = a.preparePath(!0, n[o], this._$);
              break;
            case 43:
              this.$ = a.preparePath(!1, n[o], this._$);
              break;
            case 44:
              n[o - 2].push({
                part: a.id(n[o]),
              ...
              break;
            case 45:
              this.$ = [{ part: a.id(n[o]), original: n[o] }];
              break;
            case 46:
              this.$ = [];
              break;
        ...
        parse: function parse(t) {
          ...
          for (var h, d, m, f, g, b, v, y, k, S = {}; ; ) {
            if (
              ((m = r[r.length - 1]),
              this.defaultActions[m]
                ? (f = this.defaultActions[m])
                : ((null !== h && void 0 !== h) ||
                    (h = (function() {
                      var t;
                      return (
            ...
            switch (f[0]) {
              ...
              case 2:
                ...
                v &&
                  ...
                  (a = a.slice(0, -1 * v)),
                  (i = i.slice(0, -1 * v))),
                  r.push(this.productions_[f[1]][0]),
                  a.push(S.$),
                  i.push(S._$),
                  (y = n[r[r.length - 2]][r[r.length - 1]]),
                  r.push(y);
                break;
              case 3:
                return !0;
      ...
      r = (function() {
        ...
        return (
          (t.options = {}),
          (t.performAction = function(t, e, r, a) {
            function i(t, r) {
...
var visitor = createCommonjsModule(function(t, e) {
  function r() {
    this.parents = [];
  }
  function a(t) {
...
var whitespaceControl = createCommonjsModule(function(t, e) {
  function r() {
    var t =
  ...
  ((r.prototype = new o.default()).Program = function(t) {
    var e = !this.options.ignoreStandalone,
      r = !this.isRootSeen;
    this.isRootSeen = !0;
    for (var o = t.body, l = 0, c = o.length; l < c; l++) {
      var u = o[l],
        p = this.accept(u);
      if (p) {
        var h = a(o, l, r),
        ...
        p.close && n(o, l, !0),
          ...
          e &&
            ...
            s(o, l) &&
              ...
              (u.indent = /([ \t]+$)/.exec(o[l - 1].original)[1])),
          e && m && (n((u.program || u.inverse).body), s(o, l)),
          e && f && (n(o, l), s((u.inverse || u.program).body));
      }
    }
    return t;
  }),
    (r.prototype.BlockStatement = r.prototype.DecoratorBlock = r.prototype.PartialBlockStatement = function(
      t
    ) {
      ...
      var e = t.program || t.inverse,
        ...
        l = r;
      if (r && r.chained)
        for (o = r.body[0].program; l.chained; ) {
...
var helpers$2 = createCommonjsModule(function(t, e) {
  function r(t, e) {
  ...
  (e.__esModule = !0),
    ...
    (e.preparePath = function(t, e, r) {
      ...
      for (
        ...
        if (
          ...
          if (n.length > 0)
            throw new a.default("Invalid path: " + i, { loc: r });
          ".." === c && s++;
        }
      }
      return {
    ...
    (e.prepareBlock = function(t, e, i, n, s, o) {
      ...
      var c = void 0,
        u = void 0;
      if (i) {
        if (l) throw new a.default("Unexpected inverse block on decorator", i);
...
var base$2 = createCommonjsModule(function(t, e) {
  function r(t) {
    return t && t.__esModule ? t : { default: t };
  }
  (e.__esModule = !0),
...
var compiler = createCommonjsModule(function(t, e) {
  function r(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function a() {}
  function i(t, e) {
    if (t === e) return !0;
    if (utils.isArray(t) && utils.isArray(e) && t.length === e.length) {
  ...
  (e.__esModule = !0),
    ...
    (e.compile = function(t, e, r) {
      ...
      "data" in (e = utils.extend({}, e)) || (e.data = !0),
    ...
    equals: function equals(t) {
      ...
      for (n = 0; n < e; n++) {
        var r = this.opcodes[n],
          a = t.opcodes[n];
        if (r.opcode !== a.opcode || !i(r.args, a.args)) return !1;
      }
    ...
    helperSexpr: function helperSexpr(t, e, r) {
      ...
      if (this.options.knownHelpers[n])
        ...
        if (this.options.knownHelpersOnly)
          throw new s.default(
            "You specified knownHelpersOnly, but used the unknown helper " + n,
            t
          );
        (i.strict = !0),
          (i.falsy = !0),
    ...
    classifySexpr: function classifySexpr(t) {
      ...
      if (i && !a) {
        var n = t.path.parts[0],
          s = this.options;
        s.knownHelpers[n] ? (a = !0) : s.knownHelpersOnly && (i = !1);
      }
...
var codeGen = createCommonjsModule(function(t, e) {
  function r(t, e, r) {
    if (utils.isArray(t)) {
      ...
      objectLiteral: function objectLiteral(t) {
        ...
        for (var a in t) {
          if (t.hasOwnProperty(a)) {
            var i = r(t[a], this);
            "undefined" !== i && e.push([this.quotedString(a), ":", i]);
          }
        }
...
var javascriptCompiler = createCommonjsModule(function(t, e) {
  function r(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function a(t) {
  ...
  (i.prototype = {
    ...
    compilerInfo: function compilerInfo() {
      var t = base.COMPILER_REVISION;
      return [t, base.REVISION_CHANGES[t]];
    },
    ...
    compile: function compile(t, e, r, a) {
      ...
      for (l = 0, c = d.length; l < c; l++) {
        d[l] &&
          ((p[l] = d[l]),
          m[l] && ((p[l + "_d"] = m[l]), (p.useDecorators = !0)));
      }
      return (
    ...
    createFunctionContext: function createFunctionContext(t) {
      ...
      for (var i in this.aliases) {
        ...
        this.aliases.hasOwnProperty(i) &&
          n.children &&
          n.referenceCount > 1 &&
          ((e += ", alias" + ++a + "=" + i), (n.children[0] = "alias" + a));
      }
    ...
    resolvePath: function resolvePath(t, e, r, a, i) {
      ...
      if (this.options.strict || this.options.assumeObjects)
        this.push(n(this.options.strict && i, this, e, t));
      else
        for (var o = e.length; r < o; r++) {
          this.replaceStack(function(i) {
            var n = s.nameLookup(i, e[r], t);
            return a ? [" && ", n] : [" != null ? ", n, " : ", i];
          });
        }
    },
    ...
    compileChildren: function compileChildren(t, e) {
      for (
        var r = t.children, a = void 0, i = void 0, n = 0, s = r.length;
        n < s;
        n++
      ) {
        (a = r[n]), (i = new this.compiler());
    ...
    push: function push(t) {
      return (
        t instanceof a || (t = this.source.wrap(t)), this.inlineStack.push(t), t
      );
    },
    ...
    replaceStack: function replaceStack(t) {
      ...
      if (o instanceof a) (e = ["(", (r = [o.value])]), (n = !0);
      else {
        i = !0;
    ...
    flushInline: function flushInline() {
      ...
      for (var e = 0, r = t.length; e < r; e++) {
        var i = t[e];
        if (i instanceof a) this.compileStack.push(i);
        else {
    ...
    popStack: function popStack(t) {
      ...
      if (!t && r instanceof a) return r.value;
      if (!e) {
    ...
    setupParams: function setupParams(t, e, r) {
      ...
      o && (r = []),
        ...
        this.stringParams &&
          ((a.hashTypes = this.popStack()), (a.hashContexts = this.popStack()));
      var c = this.popStack(),
        u = this.popStack();
      (u || c) &&
      ...
      return (
        ...
        this.stringParams &&
          ((a.types = this.source.generateArray(n)),
...
var handlebars$1 = createCommonjsModule(function(t, e) {
  function r(t) {
    return t && t.__esModule ? t : { default: t };
  }
  function a() {
    ...
    return (
      ...
      (t.AST = n.default),
      (t.Compiler = compiler.Compiler),
      (t.JavaScriptCompiler = s.default),
      (t.Parser = base$2.parser),
      (t.parse = base$2.parse),
      t
    );
  }
  e.__esModule = !0;
  var i = r(handlebars_runtime),
    n = r(ast),
...
var printer = createCommonjsModule(function(t, e) {
  function r() {
    this.padding = 0;
  }
  (e.__esModule = !0),
  ...
  ((r.prototype = new a.default()).pad = function(t) {
    ...
    (r.prototype.Program = function(t) {
      ...
      if (t.blockParams) {
        var n = "BLOCK PARAMS: [";
        for (a = 0, i = t.blockParams.length; a < i; a++) {
          n += " " + t.blockParams[a];
        }
        (n += " ]"), (e += this.pad(n));
      }
    ...
    (r.prototype.SubExpression = function(t) {
      for (
        var e = t.params, r = [], a = void 0, i = 0, n = e.length;
        i < n;
        i++
      ) {
      ...
      return (
        (e = "[" + r.join(", ") + "]"),
        (a = t.hash ? " " + this.accept(t.hash) : ""),
        this.accept(t.path) + " " + e + a
      );
    }),
...
voidTagNames.split(" ").forEach(function(t) {
  voidMap[t] = !0;
});
var TokenizerEventHandlers = (function(_HandlebarsNodeVisito) {
  ...
  function TokenizerEventHandlers() {
    ...
    ((_this2 = _possibleConstructorReturn(
      this,
      (
        TokenizerEventHandlers.__proto__ ||
        Object.getPrototypeOf(TokenizerEventHandlers)
      ).apply(this, arguments)
    )),
    _this2),
  ...
  _createClass(TokenizerEventHandlers, [
    ...
    },
    {
      ...
      value: function finishComment() {
        (this.currentComment.loc.end = b.pos(
          this.tokenizer.line,
    ...
    },
    {
      ...
      value: function finishData() {
        (this.currentData.loc.end = b.pos(
          this.tokenizer.line,
          this.tokenizer.column
        )),
    ...
    },
    {
      ...
      value: function finishTag() {
        var _tokenizer = this.tokenizer,
          ...
          e = _tokenizer.column,
          r = this.currentTag;
        (r.loc = b.loc(this.tagOpenLine, this.tagOpenColumn, t, e)),
          "StartTag" === r.type
            ? (this.finishStartTag(),
              (voidMap[r.name] || r.selfClosing) && this.finishEndTag(!0))
            : "EndTag" === r.type && this.finishEndTag(!1);
      }
    },
    {
      key: "finishStartTag",
        ...
        if ("EndTag" === t.type)
          throw new SyntaxError$1(
            "Invalid end tag: closing tag must not have attributes, " +
              ("in `" + t.name + "` (on line " + this.tokenizer.line + ")."),
            t.loc
          );
    ...
    },
    {
      ...
      value: function finishAttributeValue() {
        ...
        s.loc = b.loc(i, n, this.tokenizer.line, this.tokenizer.column);
        var o = b.loc(
          ...
          l = b.attr(t, s, o);
        this.currentStartTag.attributes.push(l);
      }
    },
    {
...
var es2017 = Object.freeze({
    AST: nodes,
    preprocess: preprocess,
    builders: b,
    TraversalError: TraversalError,
    cannotRemoveNode: cannotRemoveNode,
    cannotReplaceNode: cannotReplaceNode,
    cannotReplaceOrRemoveInKeyHandlerYet: cannotReplaceOrRemoveInKeyHandlerYet,
    traverse: traverse,
    Walker: Walker,
    print: build,

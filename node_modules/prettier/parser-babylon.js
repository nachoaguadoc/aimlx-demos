...
function parse(t, e, s) {
  ...
  try {
    ...
    try {
      ...
      throw parserCreateError(e.message.replace(/ \(.*\)/, ""), {
...
var parserCreateError = createError,
  lib = createCommonjsModule(function(t, e) {
    function s(t, e) {
    ...
    function i(t) {
      var e = {};
      for (var s in C) e[s] = t && null != t[s] ? t[s] : C[s];
      return e;
    }
    function r(t) {
      var e = t.split(" ");
            ...
            (!(t < 65) &&
              (t < 91 ||
                (t < 97
                  ...
                  : t < 123 ||
                    (t <= 65535
                      ? t >= 170 && F.test(String.fromCharCode(t))
                      : a(t, B) || a(t, q)))));
    }
    function h(t) {
    ...
    function p(t, e) {
      for (var s = 1, i = 0; ; ) {
        U.lastIndex = i;
        var r = U.exec(t);
        if (!(r && r.index < e)) return new X(s, e - i);
    ...
    function u(t) {
      for (var e = {}, s = 0; s < t.length; s++) e[t[s]] = !0;
      return e;
    }
    function d(t) {
      return (
    ...
    function v(t) {
      ...
      if ("JSXMemberExpression" === t.type)
        return v(t.object) + "." + v(t.property);
    ...
    function A(t) {
      ...
      var e = t.filter(function(t) {
        return (
          "estree" === t || "flow" === t || "jsx" === t || "typescript" === t
        );
      });
      if (
        (e.indexOf("flow") >= 0 &&
    ...
    var C = {
      ...
      I = {
        ...
        eof: new k("eof"),
        bracketL: new k("[", { beforeExpr: E, startsExpr: !0 }),
        bracketR: new k("]"),
        braceL: new k("{", { beforeExpr: E, startsExpr: !0 }),
        braceBarL: new k("{|", { beforeExpr: E, startsExpr: !0 }),
        braceR: new k("}"),
        braceBarR: new k("|}"),
        parenL: new k("(", { beforeExpr: E, startsExpr: !0 }),
        parenR: new k(")"),
        comma: new k(",", { beforeExpr: E }),
        semi: new k(";", { beforeExpr: E }),
        colon: new k(":", { beforeExpr: E }),
        doubleColon: new k("::", { beforeExpr: E }),
        dot: new k("."),
        question: new k("?", { beforeExpr: E }),
        questionDot: new k("?."),
        arrow: new k("=>", { beforeExpr: E }),
        template: new k("template"),
        ellipsis: new k("...", { beforeExpr: E }),
        backQuote: new k("`", { startsExpr: !0 }),
        dollarBraceL: new k("${", { beforeExpr: E, startsExpr: !0 }),
        at: new k("@"),
        hash: new k("#"),
        eq: new k("=", { beforeExpr: E, isAssign: !0 }),
        assign: new k("_=", { beforeExpr: E, isAssign: !0 }),
        incDec: new k("++/--", { prefix: !0, postfix: !0, startsExpr: !0 }),
        bang: new k("!", { beforeExpr: E, prefix: !0, startsExpr: !0 }),
        tilde: new k("~", { beforeExpr: E, prefix: !0, startsExpr: !0 }),
        pipeline: new L("|>", 0),
      ...
      M = {
        break: new S("break"),
        case: new S("case", { beforeExpr: E }),
        catch: new S("catch"),
        continue: new S("continue"),
        debugger: new S("debugger"),
        default: new S("default", { beforeExpr: E }),
        do: new S("do", { isLoop: !0, beforeExpr: E }),
        else: new S("else", { beforeExpr: E }),
        finally: new S("finally"),
        for: new S("for", { isLoop: !0 }),
        function: new S("function", { startsExpr: !0 }),
        if: new S("if"),
        return: new S("return", { beforeExpr: E }),
        switch: new S("switch"),
        throw: new S("throw", { beforeExpr: E, prefix: !0, startsExpr: !0 }),
        try: new S("try"),
        var: new S("var"),
        let: new S("let"),
        const: new S("const"),
        while: new S("while", { isLoop: !0 }),
        with: new S("with"),
        new: new S("new", { beforeExpr: E, startsExpr: !0 }),
        this: new S("this", { startsExpr: !0 }),
        super: new S("super", { startsExpr: !0 }),
        class: new S("class"),
        extends: new S("extends", { beforeExpr: E }),
        export: new S("export"),
        import: new S("import", { startsExpr: !0 }),
        yield: new S("yield", { beforeExpr: E, startsExpr: !0 }),
        null: new S("null", { startsExpr: !0 }),
        true: new S("true", { startsExpr: !0 }),
        false: new S("false", { startsExpr: !0 }),
        in: new S("in", { beforeExpr: E, binop: 7 }),
        instanceof: new S("instanceof", { beforeExpr: E, binop: 7 }),
        typeof: new S("typeof", { beforeExpr: E, prefix: !0, startsExpr: !0 }),
        void: new S("void", { beforeExpr: E, prefix: !0, startsExpr: !0 }),
        delete: new S("delete", { beforeExpr: E, prefix: !0, startsExpr: !0 })
      };
    ...
    var B = [
      ...
      G = {
        braceStatement: new W("{", !1),
        braceExpression: new W("{", !0),
        templateQuasi: new W("${", !0),
        parenStatement: new W("(", !1),
        parenExpression: new W("(", !0),
        template: new W("`", !0, !0, function(t) {
          return t.readTmplToken();
        }),
        functionExpression: new W("function", !0)
      };
    (I.parenR.updateContext = I.braceR.updateContext = function() {
      if (1 !== this.state.context.length) {
        var t = this.state.context.pop();
        t === G.braceStatement && this.curContext() === G.functionExpression
      ...
      (I.name.updateContext = function(t) {
        "of" !== this.state.value || this.curContext() !== G.parenStatement
          ? ((this.state.exprAllowed = !1),
            (t !== I._let && t !== I._const && t !== I._var) ||
              (V.test(this.input.slice(this.state.end)) &&
                (this.state.exprAllowed = !0)))
          : (this.state.exprAllowed = !t.beforeExpr);
      }),
      (I.braceL.updateContext = function(t) {
        this.state.context.push(
          this.braceIsBlock(t) ? G.braceStatement : G.braceExpression
        ),
          (this.state.exprAllowed = !0);
      }),
      ...
      (I.parenL.updateContext = function(t) {
        var e = t === I._if || t === I._for || t === I._with || t === I._while;
        this.state.context.push(e ? G.parenStatement : G.parenExpression),
          (this.state.exprAllowed = !0);
      }),
      (I.incDec.updateContext = function() {}),
      (I._function.updateContext = function() {
        this.curContext() !== G.braceStatement &&
          this.state.context.push(G.functionExpression),
          (this.state.exprAllowed = !1);
      }),
      (I.backQuote.updateContext = function() {
        this.curContext() === G.template
          ? this.state.context.pop()
          : this.state.context.push(G.template),
          (this.state.exprAllowed = !1);
      });
    var X = function(t, e) {
          ...
          return (
            ...
            (i.processComment = function(t) {
              if (!("Program" === t.type && t.body.length > 0)) {
                ...
                for (
                  n.length > 0 && c(n).start >= t.start && (e = n.pop());
                  n.length > 0 && c(n).start >= t.start;
                ...
                if (
                  ...
                  var h = c(this.state.leadingComments);
                ...
                if (s) {
                  if (s.leadingComments)
                    if (
                      ...
                      c(s.leadingComments).end <= t.start
                    )
                  ...
                  if (c(this.state.leadingComments).end <= t.start) {
        ...
        return (
          (e.init = function(t, e) {
            (this.strict = !1 !== t.strictMode && "module" === t.sourceType),
              ...
              (this.inMethod = this.inFunction = this.inParameters = this.maybeInArrowParameters = this.inGenerator = this.inAsync = this.inPropertyName = this.inType = this.inClassProperty = this.noAnonFunctionType = !1),
              (this.classLevel = 0),
              (this.labels = []),
              (this.decoratorStack = [[]]),
          ...
          (e.clone = function(e) {
            ...
            return (
              Object.keys(this).forEach(function(t) {
                var r = s[t];
                (e && "context" !== t) || !Array.isArray(r) || (r = r.slice()),
                  (i[t] = r);
              }),
              i
            );
      ...
      Y = {};
    (Y.bin = [48, 49]),
      (Y.oct = Y.bin.concat([50, 51, 52, 53, 54, 55])),
      (Y.dec = Y.oct.concat([56, 57])),
      (Y.hex = Y.dec.concat([
        65,
        66,
        67,
    ...
    var Z = function(t) {
        (this.type = t.type),
          ...
          (this.start = t.start),
          (this.end = t.end),
          (this.loc = new J(t.startLoc, t.endLoc));
      },
      tt = (function(t) {
        function e() {
          return t.apply(this, arguments) || this;
        ...
        return (
          ...
          (i.expectRelational = function(t) {
            this.isRelational(t)
              ? this.next()
              : this.unexpected(null, I.relational);
          }),
          ...
          (i.isLookaheadContextual = function(t) {
            ...
            return e.type === I.name && e.value === t;
          }),
        ...
        (function(t) {
          ...
          return (
            (i.next = function() {
              this.options.tokens &&
                !this.isLookahead &&
                this.state.tokens.push(new Z(this.state)),
            ...
            (i.setStrict = function(t) {
              if (
                ((this.state.strict = t),
                this.match(I.num) || this.match(I.string))
              ) {
                for (
            ...
            (i.skipBlockComment = function() {
              ...
              for (
                var i;
                (i = U.exec(this.input)) && i.index < this.state.pos;
                ...
                switch (t) {
                  ...
                  default:
                    if (
                      !(
                        (t > 8 && t < 14) ||
                        (t >= 5760 && K.test(String.fromCharCode(t)))
                      )
                    )
                      break t;
                    ++this.state.pos;
            ...
            (i.readToken_dot = function() {
              ...
              if (t >= 48 && t <= 57) this.readNumber(!0);
                ...
                46 === t && 46 === e
                  ? ((this.state.pos += 3), this.finishToken(I.ellipsis))
                  : (++this.state.pos, this.finishToken(I.dot));
              }
            }),
            ...
            (i.readToken_pipe_amp = function(t) {
              ...
              if (e !== t) {
                if (124 === t) {
                  if (62 === e) return void this.finishOp(I.pipeline, 2);
                  if (125 === e && this.hasPlugin("flow"))
                    return void this.finishOp(I.braceBarR, 2);
                }
                61 !== e
                  ? this.finishOp(124 === t ? I.bitwiseOR : I.bitwiseAND, 1)
                  : this.finishOp(I.assign, 2);
              ...
              return e === t
                ? ((s =
                  ...
                  61 === this.input.charCodeAt(this.state.pos + s)
                    ? void this.finishOp(I.assign, s + 1)
                    : void this.finishOp(I.bitShift, s))
                : 33 !== e ||
                  60 !== t ||
                  this.inModule ||
                  45 !== this.input.charCodeAt(this.state.pos + 2) ||
                  45 !== this.input.charCodeAt(this.state.pos + 3)
                  ? (61 === e && (s = 2), void this.finishOp(I.relational, s))
            ...
            (i.readToken_eq_excl = function(t) {
              ...
              if (61 !== e)
                return 61 === t && 62 === e
                  ? ((this.state.pos += 2), void this.finishToken(I.arrow))
                  : void this.finishOp(61 === t ? I.eq : I.bang, 1);
              this.finishOp(
                I.equality,
            ...
            (i.readToken_question = function() {
              ...
              63 === t
                ? this.finishOp(I.nullishCoalescing, 2)
                : 46 !== t || (e >= 48 && e <= 57)
                  ? (++this.state.pos, this.finishToken(I.question))
                  : ((this.state.pos += 2), this.finishToken(I.questionDot));
            }),
              ...
              switch (t) {
                case 35:
                  if (
                    ...
                    return ++this.state.pos, void this.finishToken(I.hash);
                  this.raise(this.state.pos, `Unexpected character '${l(t)}'`);
                case 46:
                  return void this.readToken_dot();
                case 40:
                  return ++this.state.pos, void this.finishToken(I.parenL);
                case 41:
                  return ++this.state.pos, void this.finishToken(I.parenR);
                case 59:
                  return ++this.state.pos, void this.finishToken(I.semi);
                case 44:
                  return ++this.state.pos, void this.finishToken(I.comma);
                case 91:
                  return ++this.state.pos, void this.finishToken(I.bracketL);
                case 93:
                  return ++this.state.pos, void this.finishToken(I.bracketR);
                case 123:
                  return void (this.hasPlugin("flow") &&
                  124 === this.input.charCodeAt(this.state.pos + 1)
                    ? this.finishOp(I.braceBarL, 2)
                    : (++this.state.pos, this.finishToken(I.braceL)));
                case 125:
                  return ++this.state.pos, void this.finishToken(I.braceR);
                case 58:
                  return void (this.hasPlugin("functionBind") &&
                  58 === this.input.charCodeAt(this.state.pos + 1)
                    ? this.finishOp(I.doubleColon, 2)
                    : (++this.state.pos, this.finishToken(I.colon)));
                case 63:
                  return void this.readToken_question();
                case 64:
                  return ++this.state.pos, void this.finishToken(I.at);
                case 96:
                  return ++this.state.pos, void this.finishToken(I.backQuote);
                case 48:
                  var e = this.input.charCodeAt(this.state.pos + 1);
                  if (120 === e || 88 === e)
                ...
                case 126:
                  return void this.finishOp(I.tilde, 1);
              }
              this.raise(this.state.pos, `Unexpected character '${l(t)}'`);
            }),
            ...
            (i.readRegexp = function() {
              ...
              a &&
                (/^[gmsiyu]*$/.test(a) ||
                  this.raise(s, "Invalid regular expression flag")),
                this.finishToken(I.regexp, { pattern: r, flags: a });
            }),
            (i.readInt = function(t, e) {
              for (
                var s = this.state.pos,
                  i = 16 === t ? Q.hex : Q.decBinOct,
                  r =
                    16 === t
                      ? Y.hex
                      : 10 === t ? Y.dec : 8 === t ? Y.oct : Y.bin,
                  a = 0,
                  n = 0,
                  o = null == e ? 1 / 0 : e;
                n < o;
            ...
            (i.readNumber = function(t) {
              ...
              var o = this.input.slice(e, this.state.pos).replace(/[_n]/g, "");
              if (r) this.finishToken(I.bigint, o);
              else {
                var h;
                i
                  ? (h = parseFloat(o))
              ...
              for (var t = "", e = this.state.pos, s = !1; ; ) {
                ...
                if (
                  ...
                  return this.state.pos === this.state.start &&
                    this.match(I.template)
                    ? 36 === i
                      ? ((this.state.pos += 2),
                        void this.finishToken(I.dollarBraceL))
                      : (++this.state.pos, void this.finishToken(I.backQuote))
                    : ((t += this.input.slice(e, this.state.pos)),
                      void this.finishToken(I.template, s ? null : t));
                if (92 === i) {
                  t += this.input.slice(e, this.state.pos);
            ...
            (i.readWord1 = function() {
              ...
              for (
                ...
                if (o(i)) this.state.pos += i <= 65535 ? 1 : 2;
                else {
                  if (92 !== i) break;
                  ...
                  (e ? n : o)(a, !0) || this.raise(r, "Invalid Unicode escape"),
                    (t += l(a)),
                    (s = this.state.pos);
                }
                e = !1;
            ...
            (i.braceIsBlock = function(t) {
              if (t === I.colon) {
                ...
                if (e === G.braceStatement || e === G.braceExpression)
                  return !e.isExpr;
              }
              return t === I._return
                ? V.test(
                ...
                : t === I._else ||
                    ...
                    (t === I.braceL
                      ? this.curContext() === G.braceStatement
                      : t === I.relational || !this.state.exprAllowed);
            }),
            (i.updateContext = function(t) {
              var e,
                s = this.state.type;
              !s.keyword || (t !== I.dot && t !== I.questionDot)
                ? (e = s.updateContext)
                  ? e.call(this, t)
      ...
      ot = (function(t) {
        function e(e, s) {
          ...
          return (
            (e = i(e)),
            (r = t.call(this, e, s) || this),
            (r.options = e),
            (r.inModule = "module" === r.options.sourceType),
            (r.input = s),
            (r.plugins = u(r.options.plugins)),
        ...
        (function(t) {
          ...
          var i = e.prototype;
          return (
            (i.parseTopLevel = function(t, e) {
              return (
                (e.sourceType = this.options.sourceType),
                this.parseBlockBody(e, !0, !0, I.eof),
            ...
            (i.parseStatement = function(t, e) {
              return (
                this.match(I.at) && this.parseDecorators(!0),
            ...
            (i.parseStatementContent = function(t, e) {
              ...
              switch (s) {
                ...
                case I._function:
                  if (this.lookahead().type === I.dot) break;
                ...
                case I._import:
                  if (
                    (this.hasPlugin("dynamicImport") &&
                      this.lookahead().type === I.parenL) ||
                    (this.hasPlugin("importMeta") &&
                      this.lookahead().type === I.dot)
                  )
                    break;
                ...
                case I.name:
                  if ("async" === this.state.value) {
                    ...
                    if (
                      (this.next(),
                      this.match(I._function) && !this.canInsertSemicolon())
                    )
                      return (
                        this.expect(I._function),
              ...
              return s === I.name &&
                "Identifier" === o.type &&
                this.eat(I.colon)
                ? this.parseLabeledStatement(i, n, o)
              ...
              if ((this.next(), this.hasPlugin("decorators2"))) {
                ...
                if (this.eat(I.parenL)) {
                  ...
                  (a.callee = i),
                    ...
                    (i = this.finishNode(a, "CallExpression")),
            ...
            (i.parseForStatement = function(t) {
              ...
              if (
                ...
                return (
                  ...
                  (!this.match(I._in) && !this.isContextual("of")) ||
              ...
              if (this.match(I._in) || this.isContextual("of")) {
            ...
            (i.parseSwitchStatement = function(t) {
              ...
              var e = (t.cases = []);
              this.expect(I.braceL), this.state.labels.push(at);
              for (var s, i; !this.match(I.braceR); )
                if (this.match(I._case) || this.match(I._default)) {
                  var r = this.match(I._case);
                  ...
                  s
                    ? s.consequent.push(this.parseStatement(!0))
                    : this.unexpected();
              return (
                s && this.finishNode(s, "SwitchCase"),
                this.next(),
            ...
            (i.parseTryStatement = function(t) {
              if (
                ...
                if ((this.next(), this.match(I.parenL))) {
                  this.expect(I.parenL), (e.param = this.parseBindingAtom());
                  var s = Object.create(null);
                  this.checkLVal(e.param, !0, s, "catch clause"),
                    this.expect(I.parenR);
                } else
                  this.expectPlugin("optionalCatchBinding"), (e.param = null);
                (e.body = this.parseBlock()),
                  (t.handler = this.finishNode(e, "CatchClause"));
              }
              return (
                (t.guardedHandlers = it),
                (t.finalizer = this.eat(I._finally) ? this.parseBlock() : null),
                t.handler ||
                  t.finalizer ||
            ...
            (i.parseLabeledStatement = function(t, e, s) {
              ...
              for (
                var a = this.state.type.isLoop
                    ? "loop"
                    : this.match(I._switch) ? "switch" : null,
            ...
            (i.parseBlock = function(t) {
              ...
              return (
                ...
                this.parseBlockBody(e, t, !1, I.braceR),
            ...
            (i.parseFor = function(t, e) {
              return (
                (t.init = e),
                this.expect(I.semi),
                (t.test = this.match(I.semi) ? null : this.parseExpression()),
                this.expect(I.semi),
                (t.update = this.match(I.parenR)
                  ? null
            ...
            (i.parseForIn = function(t, e, s) {
              var i = this.match(I._in) ? "ForInStatement" : "ForOfStatement";
              return (
            ...
            (i.parseFunction = function(t, e, s, i, r) {
              ...
              return (
                ...
                (this.match(I.name) || this.match(I._yield)) &&
            ...
            (i.parseFunctionParams = function(t, e) {
              ...
              (this.state.inParameters = !0),
                this.expect(I.parenL),
                (t.params = this.parseBindingList(I.parenR, !1, e)),
            ...
            (i.isClassProperty = function() {
              return (
                this.match(I.eq) || this.match(I.semi) || this.match(I.braceR)
              );
            }),
            ...
            (i.parseClassBody = function(t) {
              ...
              var s = { hadConstructor: !1 },
                i = [],
                r = this.startNode();
              for (r.body = [], this.expect(I.braceL); !this.eat(I.braceR); )
                if (this.eat(I.semi))
                  i.length > 0 &&
                    this.raise(
                      this.state.lastTokEnd,
                ...
                else if (this.match(I.at)) i.push(this.parseDecorator());
                else {
                  ...
                  i.length &&
                    ...
                    this.hasPlugin("decorators2") &&
                      -1 === ["method", "get", "set"].indexOf(a.kind) &&
                      a.decorators &&
            ...
            (i.parseClassMember = function(t, e, s) {
              var i = !1;
              if (this.match(I.name) && "static" === this.state.value) {
                ...
                if (this.isClassMethod()) {
                  ...
                  return (
                    ...
                    (a.key = r),
                    (a.static = !1),
                    void this.pushClassMethod(t, a, !1, !1, !1)
                  );
                }
                if (this.isClassProperty()) {
                  ...
                  return (
                    ...
                    (n.key = r),
                    (n.static = !1),
                    void t.body.push(this.parseClassProperty(n))
                  );
                }
                i = !0;
              }
            ...
            (i.parseClassMemberWithIsStatic = function(t, e, s, i) {
              var r = e,
                ...
                h = r,
                p = r;
              if (((e.static = i), this.eat(I.star)))
                return (
                  (h.kind = "method"),
                  this.parseClassPropertyName(h),
                  "PrivateName" === h.key.type
              ...
              if (
                ...
                (this.isLineTerminator() && this.match(I.star))
                  ...
                  : ((h.kind = c.name),
                    ...
                    this.checkGetterSetterParamCount(r));
            }),
            ...
            (i.parseClassPrivateProperty = function(t) {
              return (
                (this.state.inClassProperty = !0),
                (t.value = this.eat(I.eq) ? this.parseMaybeAssign() : null),
                this.semicolon(),
            ...
            (i.parseClassSuper = function(t) {
              t.superClass = this.eat(I._extends)
            ...
            (i.parseExport = function(t) {
              if (this.shouldParseExportStar()) {
                ...
                if (
                  ((t.specifiers = s),
                  this.match(I.comma) && this.lookahead().type === I.star)
                ) {
                  this.expect(I.comma);
                  ...
                  return (
                    this.eat(I._function)
                      ...
                      : this.isContextual("async") &&
                        this.lookahead().type === I._function
            ...
            (i.isExportDefaultSpecifier = function() {
              if (this.match(I.name)) return "async" !== this.state.value;
              if (!this.match(I._default)) return !1;
              var t = this.lookahead();
              return (
                t.type === I.comma || (t.type === I.name && "from" === t.value)
              );
            }),
            ...
            (i.shouldParseExportDeclaration = function() {
              return (
                ...
                this.isContextual("async") ||
                (this.match(I.at) && this.expectPlugin("decorators2"))
              );
            }),
              ...
              if (e)
                if (s) this.checkDuplicateExports(t, "default");
                  ...
                  if (
                    ...
                    for (
                      var n = 0, o = t.declaration.declarations;
                      n < o.length;
                      n++
                    ) {
                      var h = o[n];
            ...
            (i.parseExportSpecifiers = function() {
              ...
              for (this.expect(I.braceL); !this.eat(I.braceR); ) {
                if (s) s = !1;
                else if ((this.expect(I.comma), this.eat(I.braceR))) break;
                var i = this.match(I._default);
                i && !t && (t = !0);
                var r = this.startNode();
          ...
          (function(t) {
            ...
            return (
              ...
              (i.getExpression = function() {
                ...
                return (
                  this.match(I.eof) || this.unexpected(),
                  (t.comments = this.state.comments),
                  t
                );
              }),
              (i.parseExpression = function(t, e) {
                ...
                if (this.match(I.comma)) {
                  var a = this.startNodeAt(s, i);
                  for (a.expressions = [r]; this.eat(I.comma); )
              ...
              (i.parseMaybeAssign = function(t, e, s, i) {
                ...
                if (this.match(I._yield) && this.state.inGenerator) {
              ...
              (i.parseExprOp = function(t, e, s, i, r) {
                ...
                if (!(null == a || (r && this.match(I._in))) && a > i) {
              ...
              (i.parseMaybeUnary = function(t) {
                ...
                for (
                  ...
                  (h.operator = this.state.value),
                    ...
                    this.next(),
                    (o = this.finishNode(h, "UpdateExpression"));
                }
                return o;
              }),
              ...
              (i.parseSubscript = function(t, e, s, i, r) {
                ...
                if (this.match(I.questionDot)) {
                  if (
                    ...
                    i && this.lookahead().type == I.parenL)
                  )
                    return (r.stop = !0), t;
                  this.next();
                  var n = this.startNodeAt(e, s);
              ...
              (i.parseCallExpressionArguments = function(t, e, s) {
                for (var i, r = [], a = !0; !this.eat(t); ) {
                  if (a) a = !1;
                  else if ((this.expect(I.comma), this.eat(t))) break;
                  this.match(I.parenL) && !i && (i = this.state.start),
                    r.push(
                ...
                return (
                  e && i && this.shouldParseAsyncArrow() && this.unexpected(), r
                );
              }),
              ...
              (i.parseExprAtom = function(t) {
                ...
                switch (this.state.type) {
                  ...
                  case I._import:
                    return this.lookahead().type === I.dot
                      ? this.parseImportMetaProperty()
                      : (this.expectPlugin("dynamicImport"),
                        (e = this.startNode()),
                        this.next(),
                        this.match(I.parenL) || this.unexpected(null, I.parenL),
                  ...
                  case I.name:
                    ...
                    if ("await" === a.name) {
                      ...
                      if (
                        "async" === a.name &&
                        this.match(I._function) &&
                        !this.canInsertSemicolon()
                      )
                        return this.next(), this.parseFunction(e, !1, !1, !0);
                      if (s && "async" === a.name && this.match(I.name)) {
                    ...
                    if (s && !this.canInsertSemicolon() && this.eat(I.arrow)) {
                      var h = this.state.yieldInPossibleArrowParameters;
                      return (
                        (this.state.yieldInPossibleArrowParameters = null),
                        this.parseArrowExpression(e, [a]),
                        (this.state.yieldInPossibleArrowParameters = h),
                        e
                      );
                    }
                    return a;
                  ...
                  case I.regexp:
                    ...
                    return (
                      (e = this.parseLiteral(u.value, "RegExpLiteral")),
                      (e.pattern = u.pattern),
                      (e.flags = u.flags),
                      e
                    );
                  ...
                  case I.bracketL:
                    return (
                      (e = this.startNode()),
                      this.next(),
                      (e.elements = this.parseExprList(I.bracketR, !0, t)),
              ...
              (i.parseFunctionExpression = function() {
                ...
                return this.state.inGenerator && this.eat(I.dot)
              ...
              (i.parseMetaProperty = function(t, e, s) {
                return (
                  ...
                  t.property.name !== s &&
                    this.raise(
                      t.property.start,
                      `The only valid meta property for ${e.name} is ${
                        e.name
                      }.${s}`
                    ),
              ...
              (i.parseParenAndDistinguishExpression = function(t) {
                ...
                for (
                  ...
                  if (d) d = !1;
                    ...
                    (this.expect(I.comma, u.start || null),
                    this.match(I.parenR))
                  ) {
                    o = this.state.start;
                    break;
                  ...
                  if (this.match(I.ellipsis)) {
                    ...
                    (n = this.state.start),
                      c.push(this.parseParenItem(this.parseRest(), f, m)),
                      this.match(I.comma) &&
                        this.lookahead().type === I.parenR &&
                        this.raise(
                          this.state.start,
                          "A trailing comma is not permitted after the rest element"
                        );
                ...
                this.expect(I.parenR), (this.state.maybeInArrowParameters = r);
                var P = this.startNodeAt(s, i);
                if (t && this.shouldParseArrow() && (P = this.parseArrow(P))) {
                  for (var v = 0; v < c.length; v++) {
                    var g = c[v];
                    g.extra &&
                      g.extra.parenthesized &&
                      this.unexpected(g.extra.parenStart);
                  }
                  return (
                ...
                return (
                  ...
                  c.length > 1
                    ? (((e = this.startNodeAt(h, p)).expressions = c),
                      this.toReferencedList(e.expressions),
                      this.finishNodeAt(e, "SequenceExpression", y, x))
                    : (e = c[0]),
              ...
              (i.parseNew = function() {
                ...
                return (
                  ...
                  this.eat(I.questionDot) && (t.optional = !0),
              ...
              (i.parseNewArguments = function(t) {
                if (this.eat(I.parenL)) {
                  var e = this.parseExprList(I.parenR);
              ...
              (i.parseObj = function(t, e) {
                ...
                for (var n = null; !this.eat(I.braceR); ) {
                  if (r) r = !1;
                  else if ((this.expect(I.comma), this.eat(I.braceR))) break;
                  if (this.match(I.at))
                    if (this.hasPlugin("decorators2"))
                      ...
                      for (; this.match(I.at); ) s.push(this.parseDecorator());
                  ...
                  if (
                    ...
                    if (null !== n)
                      ...
                      if (this.eat(I.braceR)) break;
                      if (
                        !this.match(I.comma) ||
                        this.lookahead().type !== I.braceR
                      ) {
                        n = u;
                        continue;
                      }
                  ...
                  this.parseObjPropValue(o, c, l, h, p, t, e),
              ...
              (i.parseObjectMethod = function(t, e, s, i) {
                return s || e || this.match(I.parenL)
                  ? (i && this.unexpected(),
                    (t.kind = "method"),
                    (t.method = !0),
              ...
              (i.checkFunctionNameAndParams = function(t, e) {
                var s = this.isStrictBody(t),
                  ...
                  r = this.state.strict;
                if (
                  (s && (this.state.strict = s),
                  t.id && this.checkReservedWord(t.id, t.start, !0, !0),
                  i)
                ) {
              ...
              (i.parseIdentifierName = function(t, e) {
                ...
                var s;
                if (this.match(I.name)) s = this.state.value;
                else {
              ...
              (i.parseYield = function() {
                ...
                return (
                  ...
                  this.match(I.semi) ||
                  this.canInsertSemicolon() ||
                  (!this.match(I.star) && !this.state.type.startsExpr)
            ...
            (function(t) {
              ...
              return (
                ...
                (i.parseBindingAtom = function() {
                  switch (this.state.type) {
                    ...
                    case I.bracketL:
                      ...
                      return (
                        this.next(),
                        (t.elements = this.parseBindingList(I.bracketR, !0)),
                ...
                (i.parseBindingList = function(t, e, s) {
                  for (var i = [], r = !0; !this.eat(t); )
                    if (
                      (r ? (r = !1) : this.expect(I.comma),
                      e && this.match(I.comma))
                    )
                      i.push(null);
                    else {
                      if (this.eat(t)) break;
      ...
      lt = /^[\da-fA-F]+$/,
      ut = /^\d+$/;
    (G.j_oTag = new W("<tag", !1)),
      (G.j_cTag = new W("</tag", !1)),
      (G.j_expr = new W("<tag>...</tag>", !0, !0)),
      (I.jsxName = new k("jsxName")),
      (I.jsxText = new k("jsxText", { beforeExpr: !0 })),
      (I.jsxTagStart = new k("jsxTagStart", { startsExpr: !0 })),
      (I.jsxTagEnd = new k("jsxTagEnd")),
      (I.jsxTagStart.updateContext = function() {
        this.state.context.push(G.j_expr),
          this.state.context.push(G.j_oTag),
          (this.state.exprAllowed = !1);
      }),
      (I.jsxTagEnd.updateContext = function(t) {
        var e = this.state.context.pop();
        (e === G.j_oTag && t === I.slash) || e === G.j_cTag
          ? (this.state.context.pop(),
            (this.state.exprAllowed = this.curContext() === G.j_expr))
          : (this.state.exprAllowed = !0);
      });
    (nt.estree = function(t) {
      return (function(t) {
        ...
        var i = e.prototype;
        return (
          (i.estreeParseRegExpLiteral = function(t) {
            var e = t.pattern,
              s = t.flags,
              i = null;
            try {
          ...
          (i.parseMethod = function(e, s, i, r, a) {
            ...
            return (
              (n.kind = e.kind),
              (n = t.prototype.parseMethod.call(
                this,
                n,
                s,
                i,
      ...
      (nt.flow = function(t) {
        return (function(t) {
          ...
          var i = e.prototype;
          return (
            (i.flowParseTypeInitialiser = function(t) {
              var e = this.state.inType;
              (this.state.inType = !0), this.expect(t || I.colon);
            ...
            (i.flowParseTypeAndPredicateInitialiser = function() {
              ...
              (this.state.inType = !0), this.expect(I.colon);
              var e = null,
                s = null;
              return (
                this.match(I.modulo)
                  ...
                  : ((e = this.flowParseType()),
                    (this.state.inType = t),
                    this.match(I.modulo) && (s = this.flowParsePredicate())),
                [e, s]
              );
            }),
            ...
            (i.flowParseDeclareFunction = function(t) {
              ...
              (s.params = r.params), (s.rest = r.rest), this.expect(I.parenR);
            ...
            (i.flowParseDeclare = function(t, e) {
              if (this.match(I._class)) return this.flowParseDeclareClass(t);
              if (this.match(I._function))
                return this.flowParseDeclareFunction(t);
              if (this.match(I._var)) return this.flowParseDeclareVariable(t);
            ...
            (i.flowParseDeclareModule = function(t) {
              ...
              var s = (t.body = this.startNode()),
                i = (s.body = []);
              for (this.expect(I.braceL); !this.match(I.braceR); ) {
                var r = this.startNode();
                if (this.match(I._import)) {
              ...
              this.expect(I.braceR), this.finishNode(s, "BlockStatement");
              var n = null,
                o = !1,
                h =
            ...
            (i.flowParseDeclareExportDeclaration = function(t, e) {
              if ((this.expect(I._export), this.eat(I._default)))
                return (
                  this.match(I._function) || this.match(I._class)
            ...
            (i.flowParseTypeAlias = function(t) {
              return (
                ...
                this.isRelational("<")
                  ? (t.typeParameters = this.flowParseTypeParameterDeclaration())
                  : (t.typeParameters = null),
                (t.right = this.flowParseTypeInitialiser(I.eq)),
                this.semicolon(),
            ...
            (i.flowParseOpaqueType = function(t, e) {
              return (
                ...
                (t.supertype = null),
                this.match(I.colon) &&
                  (t.supertype = this.flowParseTypeInitialiser(I.colon)),
                (t.impltype = null),
                e || (t.impltype = this.flowParseTypeInitialiser(I.eq)),
                this.semicolon(),
            ...
            (i.flowParseTypeParameter = function() {
              ...
              return (
                ...
                this.match(I.eq) &&
                  (this.eat(I.eq), (t.default = this.flowParseType())),
            ...
            (i.flowParseTypeParameterDeclaration = function() {
              ...
              (e.params = []),
                (this.state.inType = !0),
                this.isRelational("<") || this.match(I.jsxTagStart)
                  ? this.next()
                  : this.unexpected();
              do {
                e.params.push(this.flowParseTypeParameter()),
                  this.isRelational(">") || this.expect(I.comma);
            ...
            (i.flowParseObjectPropertyKey = function() {
              return this.match(I.num) || this.match(I.string)
                ? this.parseExprAtom()
                : this.parseIdentifier(!0);
            }),
            (i.flowParseObjectTypeIndexer = function(t, e, s) {
              return (
                (t.static = e),
                this.expect(I.bracketL),
                this.lookahead().type === I.colon
              ...
              for (
                t.params = [],
                  ...
                  this.isRelational("<") &&
                    (t.typeParameters = this.flowParseTypeParameterDeclaration()),
                  this.expect(I.parenL);
                !this.match(I.parenR) && !this.match(I.ellipsis);

              )
                t.params.push(this.flowParseFunctionTypeParam()),
                  this.match(I.parenR) || this.expect(I.comma);
              return (
                this.eat(I.ellipsis) &&
            ...
            (i.flowParseObjectType = function(t, e, s) {
              ...
              var a, n;
              for (
                e && this.match(I.braceBarL)
                  ? (this.expect(I.braceBarL), (a = I.braceBarR), (n = !0))
                  : (this.expect(I.braceL), (a = I.braceR), (n = !1)),
                  r.exact = n;
                !this.match(a);
                ...
                if (this.match(I.bracketL))
                  r.indexers.push(this.flowParseObjectTypeIndexer(h, o, p));
                else if (this.match(I.parenL) || this.isRelational("<"))
            ...
            (i.flowParseObjectTypeProperty = function(t, e, s, i, r) {
              ...
              var a = !1;
              return (
                this.isRelational("<") || this.match(I.parenL)
            ...
            (i.flowParseTupleType = function() {
              var t = this.startNode();
              for (
                t.types = [], this.expect(I.bracketL);
                this.state.pos < this.input.length &&
                !this.match(I.bracketR) &&
                (t.types.push(this.flowParseType()), !this.match(I.bracketR));
            ...
            (i.flowParseFunctionTypeParam = function() {
              var t = null,
                ...
                r = this.lookahead();
              return (
                r.type === I.colon || r.type === I.question
                  ? ((t = this.parseIdentifier()),
                    this.eat(I.question) && (e = !0),
            ...
            (i.flowParseFunctionTypeParams = function(t) {
              ...
              for (
                ...
                t.push(this.flowParseFunctionTypeParam()),
                  this.match(I.parenR) || this.expect(I.comma);
              return (
                this.eat(I.ellipsis) && (e = this.flowParseFunctionTypeParam()),
                { params: t, rest: e }
              );
            }),
            ...
            (i.flowParsePostfixType = function() {
              for (
                ...
                !this.canInsertSemicolon() && this.match(I.bracketL);
            ...
            (i.flowParseAnonFunctionWithoutParens = function() {
              ...
              if (!this.state.noAnonFunctionType && this.eat(I.arrow)) {
                var e = this.startNodeAt(t.start, t.loc.start);
                return (
            ...
            (i.flowParseIntersectionType = function() {
              var t = this.startNode();
              this.eat(I.bitwiseAND);
              var e = this.flowParseAnonFunctionWithoutParens();
              for (t.types = [e]; this.eat(I.bitwiseAND); )
            ...
            (i.flowParseUnionType = function() {
              var t = this.startNode();
              this.eat(I.bitwiseOR);
              var e = this.flowParseIntersectionType();
              for (t.types = [e]; this.eat(I.bitwiseOR); )
            ...
            (i.parseConditional = function(e, s, i, r, a) {
              var n = this;
              if (!this.match(I.question)) return e;
              if (a) {
                ...
                try {
                  ...
                  if (t instanceof SyntaxError)
                    return (
                      (this.state = o), (a.start = t.pos || this.state.start), e
                    );
                  throw t;
                }
              }
              this.expect(I.question);
              ...
              if (d || y.length > 0) {
                var x = p.concat();
                if (y.length > 0) {
                  (this.state = h), (this.state.noArrowAt = x);
                  for (var P = 0; P < y.length; P++) x.push(y[P].start);
                  var v = this.tryParseConditionalConsequent();
                  (u = v.consequent), (d = v.failed);
                  var g = this.getArrowLikeExpressions(u);
                  (m = g[0]), (y = g[1]);
                }
                if (
                  (d &&
                  ...
                  (this.state = h),
                    (this.state.noArrowAt = x.concat(m[0].start));
                  var b = this.tryParseConditionalConsequent();
                  (u = b.consequent), (d = b.failed);
                }
            ...
            (i.parseParenItem = function(e, s, i) {
              if (
                ...
                this.eat(I.question) && (e.optional = !0),
                this.match(I.colon))
              ) {
                var r = this.startNodeAt(s, i);
                return (
            ...
            (i.shouldParseExportStar = function() {
              return (
                ...
                (this.isContextual("type") && this.lookahead().type === I.star)
              );
            }),
            ...
            (i.isClassProperty = function() {
              return (
                this.match(I.colon) || t.prototype.isClassProperty.call(this)
              );
            }),
            ...
            (i.parseObjPropValue = function(e, s, i, r, a, n, o) {
              ...
              this.isRelational("<") &&
                ...
                this.match(I.parenL) || this.unexpected()),
                t.prototype.parseObjPropValue.call(this, e, s, i, r, a, n, o),
            ...
            (i.parseImportSpecifiers = function(e) {
              ...
              var s = null;
              if (
                (this.match(I._typeof)
                  ? (s = "typeof")
                  : this.isContextual("type") && (s = "type"),
                s)
              ) {
                var i = this.lookahead();
                (y(i) || i.type === I.braceL || i.type === I.star) &&
            ...
            (i.parseImportSpecifier = function(t) {
              ...
              if (
                ...
                null === r || this.match(I.name) || this.state.type.keyword
                  ? ((e.imported = i),
                    (e.importKind = null),
                    (e.local = this.parseIdentifier()))
                  : ((e.imported = n),
              ...
              o &&
                ...
                (o || h) && this.checkReservedType(e.local.name, e.local.start),
                !a ||
                  o ||
                  h ||
            ...
            (i.parseMaybeAssign = function(e, s, i, r) {
              var a = this,
                n = null;
              if (I.jsxTagStart && this.match(I.jsxTagStart)) {
                var o = this.state.clone();
                try {
              ...
              if (this.match(I.colon)) {
                ...
                try {
                  ...
                  (r.typeAnnotation = a[0]),
                    ...
                    this.match(I.arrow) || this.unexpected(),
                    (e.returnType = r.typeAnnotation
                      ? this.finishNode(r, "TypeAnnotation")
                      : null);
                } catch (t) {
            ...
            (i.shouldParseArrow = function() {
              return (
                this.match(I.colon) || t.prototype.shouldParseArrow.call(this)
              );
            }),
            ...
            (i.parseSubscripts = function(e, s, i, r) {
              if (
                ...
                var n,
                  o = this.state.clone();
                try {
                  var h = this.parseAsyncArrowWithTypeParameters(s, i);
                  if (h) return h;
                } catch (t) {
                  n = t;
                }
      ...
      (nt.jsx = function(t) {
        return (function(t) {
          ...
          return (
                  ...
                  case 123:
                    return this.state.pos === this.state.start
                      ? 60 === s && this.state.exprAllowed
                        ? (++this.state.pos, this.finishToken(I.jsxTagStart))
                        : this.getTokenFromCode(s)
                      : ((t += this.input.slice(e, this.state.pos)),
                        this.finishToken(I.jsxText, t));
                  case 38:
                    (t += this.input.slice(e, this.state.pos)),
                ...
                t: for (;;)
                  switch (this.state.type) {
                    ...
                    case I.jsxText:
                      ...
                      break;
                    case I.braceL:
                      this.lookahead().type === I.ellipsis
            ...
            (i.parseExprAtom = function(e) {
              return this.match(I.jsxText)
                ? this.parseLiteral(this.state.value, "JSXText")
                : this.match(I.jsxTagStart)
            ...
            (i.readToken = function(e) {
              ...
              if (s === G.j_expr) return this.jsxReadToken();
              if (s === G.j_oTag || s === G.j_cTag) {
                if (n(e)) return this.jsxReadWord();
                if (62 === e)
                  return ++this.state.pos, this.finishToken(I.jsxTagEnd);
                if ((34 === e || 39 === e) && s === G.j_oTag)
            ...
            (i.updateContext = function(e) {
              if (this.match(I.braceL)) {
                var s = this.curContext();
                s === G.j_oTag
                  ? this.state.context.push(G.braceExpression)
                  : s === G.j_expr
                    ? this.state.context.push(G.templateQuasi)
                    : t.prototype.updateContext.call(this, e),
                  (this.state.exprAllowed = !0);
              } else {
                if (!this.match(I.slash) || e !== I.jsxTagStart)
                  return t.prototype.updateContext.call(this, e);
                (this.state.context.length -= 2),
                  this.state.context.push(G.j_cTag),
                  (this.state.exprAllowed = !1);
              }
            }),
            e
          ...
          return (
            ...
            (i.tsIsListTerminator = function(t) {
              switch (t) {
                case "EnumMembers":
                case "TypeMembers":
                  return this.match(I.braceR);
                case "HeritageClauseElement":
                  return this.match(I.braceL);
                case "TupleElementTypes":
                  return this.match(I.bracketR);
            ...
            (i.tsParseDelimitedListWorker = function(t, e, s) {
              for (var i = []; !this.tsIsListTerminator(t); ) {
                var r = e();
                if (null == r) return;
                if ((i.push(r), !this.eat(I.comma))) {
                  if (this.tsIsListTerminator(t)) break;
                  return void (s && this.expect(I.comma));
                }
              }
              return i;
            }),
            (i.tsParseBracketedList = function(t, e, s, i) {
              i || (s ? this.expect(I.bracketL) : this.expectRelational("<"));
              var r = this.tsParseDelimitedList(t, e);
              return (
                s ? this.expect(I.bracketR) : this.expectRelational(">"), r
              );
            }),
            ...
            (i.tsParseTypeParameter = function() {
              ...
              return (
                ...
                this.eat(I._extends) && (t.constraint = this.tsParseType()),
                this.eat(I.eq) && (t.default = this.tsParseType()),
            ...
            (i.tsParseBindingListForSignature = function() {
              var t = this;
              return this.parseBindingList(I.parenR).map(function(e) {
            ...
            (i.tsParseSignatureMember = function(t) {
              var e = this.startNode();
              return (
                "TSConstructSignatureDeclaration" === t && this.expect(I._new),
                this.tsFillSignature(I.colon, e),
            ...
            (i.tsParsePropertyOrMethodSignature = function(t, e) {
              ...
              var s = t;
              if (e || (!this.match(I.parenL) && !this.isRelational("<"))) {
                var i = s;
                e && (i.readonly = !0);
              ...
              var a = s;
              return (
                this.tsFillSignature(I.colon, a),
                this.tsParseTypeMemberSemicolon(),
                this.finishNode(a, "TSMethodSignature")
              );
            }),
            (i.tsParseTypeMember = function() {
              if (this.match(I.parenL) || this.isRelational("<"))
            ...
            (i.tsIsStartOfConstructSignature = function() {
              return (
                this.next(), this.match(I.parenL) || this.isRelational("<")
              );
            }),
            ...
            (i.tsIsStartOfMappedType = function() {
              return (
                ...
                !!this.match(I.bracketL) &&
                  (this.next(),
                  !!this.tsIsIdentifier() && (this.next(), this.match(I._in)))
              );
            }),
            ...
            (i.tsParseFunctionOrConstructorType = function(t) {
              var e = this.startNode();
              return (
                "TSConstructorType" === t && this.expect(I._new),
                this.tsFillSignature(I.arrow, e),
                this.finishNode(e, t)
              );
            }),
            ...
            (i.tsParseNonArrayType = function() {
              switch (this.state.type) {
                ...
                case I._void:
                case I._null:
                  var t = this.match(I._void)
                    ? "TSVoidKeyword"
                    : this.match(I._null)
                      ? "TSNullKeyword"
                      : T(this.state.value);
                  if (void 0 !== t && this.lookahead().type !== I.dot) {
                    var e = this.startNode();
            ...
            (i.tsParseArrayTypeOrHigher = function() {
              for (
                ...
                !this.hasPrecedingLineBreak() && this.eat(I.bracketL);
            ...
            (i.tsSkipParameterStart = function() {
              return !(
                (!this.match(I.name) && !this.match(I._this)) ||
                (this.next(), 0)
              );
            }),
            (i.tsIsUnambiguouslyStartOfFunctionType = function() {
              if ((this.next(), this.match(I.parenR) || this.match(I.ellipsis)))
                return !0;
              if (this.tsSkipParameterStart()) {
                if (
                  ...
                  return !0;
                if (this.match(I.parenR) && (this.next(), this.match(I.arrow)))
                  return !0;
              }
              return !1;
            }),
            (i.tsParseTypeOrTypePredicateAnnotation = function(t) {
              ...
              return (
                (r.parameterName = s),
                (r.typeAnnotation = i),
                (e.typeAnnotation = this.finishNode(r, "TSTypePredicate")),
                this.finishNode(e, "TSTypeAnnotation")
              );
            }),
            (i.tsTryParseTypeOrTypePredicateAnnotation = function() {
              return this.match(I.colon)
                ? this.tsParseTypeOrTypePredicateAnnotation(I.colon)
                : void 0;
            }),
            ...
            (i.tsTryParseTypeArgumentsInExpression = function() {
              ...
              return this.tsTryParseAndCatch(function() {
                ...
                return (
                  t.expectRelational(">"),
                  (e.params = s),
                  t.finishNode(e, "TSTypeParameterInstantiation"),
                  t.expect(I.parenL),
                  e
                );
              });
            ...
            (i.tsParseEnumMember = function() {
              var t = this.startNode();
              return (
                (t.id = this.match(I.string)
                  ? this.parseLiteral(this.state.value, "StringLiteral")
                  : this.parseIdentifier(!0)),
                this.eat(I.eq) && (t.initializer = this.parseMaybeAssign()),
            ...
            (i.tsParseDeclaration = function(t, e, s) {
              switch (e) {
                ...
                case "interface":
                  ...
                  break;
                case "module":
                  if ((s && this.next(), this.match(I.string)))
            ...
            (i.parseAssignableListItem = function(t, e) {
              ...
              if (s || i) {
                ...
                return (
                  (n.parameter = a), this.finishNode(n, "TSParameterProperty")
                );
              }
            ...
            (i.parseFunctionBodyAndFinish = function(e, s, i) {
              ...
              r && !this.match(I.braceL) && this.isLineTerminator()
                ? this.finishNode(e, r)
                : t.prototype.parseFunctionBodyAndFinish.call(this, e, s, i);
            }),
            ...
            (i.parseNewArguments = function(e) {
              ...
              if (this.isRelational("<")) {
                var i = this.tsTryParseAndCatch(function() {
                  ...
                  return s.match(I.parenL) || s.unexpected(), t;
                });
            ...
            (i.parseExprOp = function(e, s, i, r, a) {
              if (
                ...
                return (
                  (n.expression = e),
                  (n.typeAnnotation = this.tsParseType()),
            ...
            (i.checkReservedWord = function(t, e, s, i) {}),
            (i.checkDuplicateExports = function() {}),
            (i.parseImport = function(e) {
              return this.match(I.name) && this.lookahead().type === I.eq
            ...
            (i.parseExportDeclaration = function(e) {
              ...
              return (
                this.match(I.name) && (s = this.tsTryParseExportDeclaration()),
            ...
            (i.parseMaybeAssign = function() {
              ...
              try {
                ...
                if (e) throw e;
                return (
                  b(!this.hasPlugin("jsx")),
                  (this.state = c),
                  (u = t.prototype.parseMaybeAssign).call.apply(
                    u,
                    [this].concat(i)
                  )
                );
              ...
              return (
                p &&
                  0 !== p.params.length &&
                  this.resetStartLocationFromNode(h, p.params[0]),
                (h.typeParameters = p),
                h
              );
            }),
            ...
            (i.parseArrow = function(e) {
              if (this.match(I.colon)) {
                var s = this.state.clone();
                try {
                  var i = this.tsParseTypeOrTypePredicateAnnotation(I.colon);
                  this.canInsertSemicolon() && this.unexpected(),
                    this.match(I.arrow) || this.unexpected(),
                    (e.returnType = i);
                } catch (t) {
    ...
    (e.parse = function(t, e) {
      if (!e || "unambiguous" !== e.sourceType) return w(e, t).parse();
      e = Object.assign({}, e);
      try {
        e.sourceType = "module";
        var s = w(e, t).parse();
        return N(s) || (s.program.sourceType = "script"), s;
      } catch (s) {
        try {

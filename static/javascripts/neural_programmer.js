...
function new_neural_programmer_answer(np, debug) {
	...
	for (var i=0, l=debug.ops.length; i<l; i++) { 
		...
		steps += "Step " + index + ": Perform operation <b><span class='op'>" + op + "</span></b> over column <b><span final=" + final + " rows=" + rows_selector + " class='col'>" + col + "</span></b>. Rows selected are <b> " + rows + "</b>-<br>";	
	}

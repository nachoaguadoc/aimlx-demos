			...
			$('#next').click(function(e){
				...
				if (selected_cells.length > 0) {
					...
					$('#content').click(function(e){
						...
						$('tr td').off('click');
						submit_feedback(last_question);
						$('#to_replace').html("<div>Submitted answer: <b>" + answer + "</b>.</div><div>Thank you for your feedback! Ask another question :)</div>");
						$("#input_text").focus();
					})
...
function submit(input_text) {
	...
	*/
	...
	var data = {"question": processed_text, "table_key": table_key, "user_id": getCookie('user_id'), "demo": "steps", "timestamp": timestamp, "question_id": question_id};
